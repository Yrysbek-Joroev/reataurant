...
// проверка на совпадение айди  с заданым если совпадает , то его свойство count (количествустанавливается равным заданному count (новое количество). 
...
// Функция calcTotalPrice вызывается с аргументом cart.products (массив продуктов в корзине),результат сохраняется в свойство totalPrice объекта cart.
cart.totalPrice = calcTotalPrice(cart.products);
